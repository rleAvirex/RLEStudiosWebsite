...
const SAMPLE_PRODUCTS = [
  {
    ...
    tags: JSON.stringify(['garage', 'vehicle', 'impound', 'parking']),
    isFeatured: true,
    version: '2.3.1',
  ...
  },
  {
    ...
    tags: JSON.stringify(['hud', 'ui', 'interface', 'minimal']),
    isFeatured: true,
    version: '3.1.0',
    framework: 'ESX / QBCore',
    rating: 4.8,
  ...
  },
  {
    ...
    tags: JSON.stringify(['drugs', 'economy', 'processing', 'gang']),
    isFeatured: true,
    version: '1.8.2',
    framework: 'QBCore',
    rating: 4.7,
  ...
  },
  {
    ...
    tags: JSON.stringify(['banking', 'economy', 'atm', 'loans']),
    isFeatured: false,
    version: '2.0.0',
    framework: 'ESX / QBCore',
    rating: 4.9,
  ...
  },
  {
    ...
    tags: JSON.stringify(['housing', 'property', 'interior', 'storage']),
    isFeatured: false,
    version: '1.5.3',
    framework: 'QBCore',
    rating: 4.6,
  ...
  },
  {
    ...
    tags: JSON.stringify(['police', 'mdt', 'law', 'job']),
    isFeatured: true,
    version: '4.2.0',
    framework: 'ESX / QBCore',
    rating: 5.0,
  ...
  },
  {
    ...
    tags: JSON.stringify(['inventory', 'core', 'items', 'drag-drop']),
    isFeatured: false,
    version: '2.1.0',
    framework: 'ESX / QBCore',
    rating: 4.8,
  ...
  },
  {
    ...
    tags: JSON.stringify(['ems', 'medical', 'job', 'revive']),
    isFeatured: false,
    version: '1.3.0',
    framework: 'ESX / QBCore',
    rating: 4.7,
  ...
  },
  {
    ...
    tags: JSON.stringify(['carwash', 'vehicle', 'cleaning', 'simple']),
    isFeatured: false,
    version: '1.1.0',
    framework: 'ESX / QBCore',
    rating: 4.5,
